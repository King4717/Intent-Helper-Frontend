...
export default function App
  ...
  const handleIntent = intent
    ...
    if intent toLowerCase includes swap
      ...
      parsedData amount = intent match d Unknown
      parsedData token = intent match usdc eth|btc to UpperCase Unknown
      parsedData chain = Polygon cheapest chain
      else if intent toLowerCase includes send
      parsedData.action = Send
      parsedData.amount = intent.match Unknown
      parsedData.token = intent.match(/eth|usdc
                                       btc toUpperCase Unknown
